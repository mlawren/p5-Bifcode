...
sub encode_bifcode {
    ...
    bless \(&_encode_bifcode)[0], __PACKAGE__ . '::BIFCODE2';
}
...
=head1 SYNOPSIS
    ...
    use utf8;
    use boolean;
    use Bifcode2 qw( encode_bifcode decode_bifcode );
...
Bifcode2::REAL or Bifcode2::UTF8. The C<force_bifcode> function below
