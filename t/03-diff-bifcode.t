...
use Bifcode2 'encode_bifcode', 'diff_bifcode';

eval { diff_bifcode() };
isa_ok $@, ['Bifcode2::Error::DiffUsage'], 'diff_bifcode not enough arguments';

eval { diff_bifcode( 1, 2, 3, 4 ) };
isa_ok $@, ['Bifcode2::Error::DiffUsage'], 'diff_bifcode too many arguments';
